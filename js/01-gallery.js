...
galleryItems.map((imgObjekt) => {
   ...
   divGaleryItem.class="gallery__item";
   linkGaleryItem.class="gallery__link";
...
styleLiinks.href="https://cdn.jsdelivr.net/npm/basiclightbox@5.0.4/dist/basicLightbox.min.css";

const scriptTag = document.createElement('script');
scriptTag.src="https://cdn.jsdelivr.net/npm/basiclightbox@5.0.4/dist/basicLightbox.min.js"; 
